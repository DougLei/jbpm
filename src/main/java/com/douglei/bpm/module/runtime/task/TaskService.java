...
public class TaskService {
	...
	public ExecutionResult<Integer> complete(int taskId) {
		List<Object> taskIdParams = Arrays.asList(taskId);
		...
		// 处理并获取当前任务的流程变量
		Map<String, Object> variableMap = getVariableMap(taskIdParams, historyTask);
	...
	// 获取指定任务id的流程变量map集合
	private Map<String, Object> getVariableMap(List<Object> taskIdParams, HistoryTask historyTask){
