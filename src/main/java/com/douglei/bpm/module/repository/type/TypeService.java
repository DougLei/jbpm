...
public class TypeService {
	...
	public ExecutionResult delete(int typeId, boolean strict) {
		...
		if(childrenCount> 0 || refProessCount> 0) { 
			...
			SessionContext.getSQLSession().executeUpdate("Type", "updateProcdefRefType", paramMap);
		}
	...
	private void recursiveQueryChildrenIds(List<Object[]> childrenIds, List<Object> ids) {
		...
		recursiveQueryChildrenIds(SessionContext.getSQLSession().query_("Type", "queryChildrenIds", childrenIds), ids);
	}
}
