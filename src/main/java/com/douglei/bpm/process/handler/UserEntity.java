...
public class UserEntity {
	...
	public UserEntity(String currentHandleUserId, List<String> assignedUserIds) {
		this(currentHandleUserId, null, null, null, assignedUserIds);
	}
	public UserEntity(String currentHandleUserId, String suggest, Attitude attitude, String reason, List<String> assignedUserIds) {
		this.currentHandleUserId = currentHandleUserId;
		this.suggest = suggest;
		this.attitude = attitude;
		this.reason = reason;
		this.assignedUserIds = (assignedUserIds==null)?new ArrayList<String>():assignedUserIds;
	}
