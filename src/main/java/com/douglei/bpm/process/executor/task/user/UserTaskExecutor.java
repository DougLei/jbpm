...
public class UserTaskExecutor extends Executor<UserTaskMetadata, ExecutionParameter> {

	@Override
	public ExecutionResult<?> execute(UserTaskMetadata metadata, ExecutionParameter parameter) {
		// TODO 用户任务执行器
