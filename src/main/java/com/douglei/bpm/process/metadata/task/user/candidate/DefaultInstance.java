...
import com.douglei.bpm.process.api.user.task.handle.policy.impl.ClaimBySinglePolicy;
...
public class DefaultInstance {
	 ...
	 * 默认的认领策略实体
	 */
	public static final ClaimPolicyEntity DEFAULT_CLAIM_POLICY_ENTITY = new ClaimPolicyEntity(ClaimBySinglePolicy.POLICY_NAME, null);
